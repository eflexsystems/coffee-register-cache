...
(function() {
  var CoffeeScript, compileCoffeeScriptAndCache, crypto, debug, definedKeysWithoutKeys, fs, getCachePath, getCachedJavaScript, getRootModule, ignoredOptions, log, path, requireCoffeeScript, stringifyOptions, writeFileAtomic,
    indexOf = [].indexOf;
